...
//轮播图接口
export const getBanner = () =>axios.get("/api/v1/pub/video/indexBanner")

//视频列表接口
export const getVideoList = ()=>axios.get("/api/v1/pub/video/listVideo")
...
//订单列表
export const getOrderList = (token)=>axios.get("/api/v1/pri/order/listOrder",{
    params:{
        "token":token
    }
})
